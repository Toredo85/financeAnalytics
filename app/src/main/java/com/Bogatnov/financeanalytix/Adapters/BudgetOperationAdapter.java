...
public class BudgetOperationAdapter extends RecyclerView.Adapter<BudgetOperationAdapter.OperationViewHolder> {
    ...
    private BudgetOperationAdapter.OnOperationClickListener onOperationClickListener;
    private int position;
    private static final MyValueFormatter mvf = new MyValueFormatter("р.");

    public BudgetOperationAdapter(BudgetOperationAdapter.OnOperationClickListener onOperationClickListener) {
        this.onOperationClickListener = onOperationClickListener;
    }

    @NonNull
    @Override
    public BudgetOperationAdapter.OperationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.budget_row, parent, false);
        return new BudgetOperationAdapter.OperationViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final BudgetOperationAdapter.OperationViewHolder holder, int position) {
...
//            directionTextView.setText(direct);
    ...
    public void deleteItem(int position, DBActions db){
        ...
        db.delOperation(operation.getId(), "budgetoperations");
        notifyDataSetChanged();
    }
